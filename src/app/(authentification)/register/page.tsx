...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen pageBackgroundColor flex items-center justify-center p-4">
      <Card className="w-full max-w-xl bg-pastel-dark-blue border-pastel-blue">
        <div className="p-8">
          <div className="mb-8">
            <BackButton />
            <div
              className={cn(
                ...
                isCompany ? "bg-pastel-green" : "bg-pastel-red"
              )}
            >
          ...
          <RegisterFormBody />
          <Separator className="mt-6 mb-4 border-t border-pastel-blue text-center" />
          <TextLinkButton
