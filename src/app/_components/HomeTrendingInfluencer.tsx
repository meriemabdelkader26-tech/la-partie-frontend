  ...
  return (
    <section className="py-20 px-4 border-t border-pastel-blue">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-pastel-dark-blue mb-4">
          Trending Influencers
        </h2>
        <p className="text-center text-pastel-blue mb-16 text-lg">
      ...
      <div className="flex items-center justify-center mt-10">
        <Button
          className="bg-primary hover:bg-primary-dark text-white font-medium py-2 disabled:bg-primary/50 w-full lg:w-1/4"
