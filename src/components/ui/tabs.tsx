...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-gray-100 text-black inline-flex h-11 w-full items-center justify-center rounded-lg p-[3px] border border-black/10",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-gray-700 hover:text-black hover:bg-gray-200/80",
        "data-[state=active]:bg-black data-[state=active]:text-white data-[state=active]:border-black",
        "focus-visible:ring-black/20 focus-visible:outline-black",
        className
      )}
      {...props}
    />
